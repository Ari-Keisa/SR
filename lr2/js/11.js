...
// Маска
const texture = new THREE.TextureLoader().load('./masks/m11.png');
...
// Квамі
const kwamiTexture = new THREE.TextureLoader().load('./kwami/k11.png');
...
// Прикраса
const dopTexture = new THREE.TextureLoader().load('./dop/11.png');
