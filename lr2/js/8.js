...
// Маска
const texture = new THREE.TextureLoader().load('./masks/m8.png');
...
// Квамі
const kwamiTexture = new THREE.TextureLoader().load('./kwami/k8.png');
...
// Прикраса
const dopTexture = new THREE.TextureLoader().load('./dop/8.png');
