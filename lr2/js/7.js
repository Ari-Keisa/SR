...
// Маска
const texture = new THREE.TextureLoader().load('./masks/m7.png');
...
// Квамі
const kwamiTexture = new THREE.TextureLoader().load('./kwami/k7.png');
...
// Прикраса
const dopTexture = new THREE.TextureLoader().load('./dop/7.png');
