...
// Маска
const texture = new THREE.TextureLoader().load('./masks/m2.png');
...
// Квамі
const kwamiTexture = new THREE.TextureLoader().load('./kwami/k2.png');
...
// Прикраса
const dopTexture = new THREE.TextureLoader().load('./dop/2.png');
