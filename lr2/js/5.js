...
// Маска
const texture = new THREE.TextureLoader().load('./masks/m5.png');
...
// Квамі
const kwamiTexture = new THREE.TextureLoader().load('./kwami/k5.png');
...
// Прикраса
const dopTexture = new THREE.TextureLoader().load('./dop/5.png');
