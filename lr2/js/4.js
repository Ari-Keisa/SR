...
// Маска
const texture = new THREE.TextureLoader().load('./masks/m4.png');
...
// Квамі
const kwamiTexture = new THREE.TextureLoader().load('./kwami/k4.png');
...
// Прикраса
const dopTexture = new THREE.TextureLoader().load('./dop/4.png');
