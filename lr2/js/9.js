...
// Маска
const texture = new THREE.TextureLoader().load('./masks/m9.png');
...
// Квамі
const kwamiTexture = new THREE.TextureLoader().load('./kwami/k9.png');
...
// Прикраса
const dopTexture = new THREE.TextureLoader().load('./dop/9.png');
