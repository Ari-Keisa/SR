...
// Маска
const texture = new THREE.TextureLoader().load('./masks/m3.png');
...
// Квамі
const kwamiTexture = new THREE.TextureLoader().load('./kwami/k3.png');
...
// Прикраса
const dopTexture = new THREE.TextureLoader().load('./dop/3.png');
