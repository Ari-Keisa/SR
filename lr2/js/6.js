...
// Маска
const texture = new THREE.TextureLoader().load('./masks/m6.png');
...
// Квамі
const kwamiTexture = new THREE.TextureLoader().load('./kwami/k6.png');
...
// Прикраса
const dopTexture = new THREE.TextureLoader().load('./dop/6.png');
